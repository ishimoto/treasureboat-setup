...
import org.treasureboat.foundation.kv.TBFKeyValueCoding;

public class KeyValueCodingProtectedAccessor extends TBFKeyValueCoding.ValueAccessor {
	...
	public Object methodValue(Object object, Method method) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException {
		return method.invoke(object, TBFConstants.EmptyObjectArray);
	}

	@Override
	public void setMethodValue(Object object, Method method, Object object1) throws IllegalArgumentException, IllegalAccessException,
