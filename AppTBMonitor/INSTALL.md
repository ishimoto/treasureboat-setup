...
sudo -u appserver curl -fLO https://treasureboat.nyc3.digitaloceanspaces.com/TBDeploy/v17/AppTBMonitor_embedded_20260711_1935.woa.tar.gz
sudo -u appserver tar xzf AppTBMonitor_embedded_20260711_1935.woa.tar.gz
# stable name the systemd unit points at (symlink = swap-and-restart upgrades):
sudo -u appserver ln -sfn AppTBMonitor_embedded_20260711_1935.woa AppTBMonitor.woa
sudo chown -R appserver:appserveradm AppTBMonitor.woa AppTBMonitor_embedded_20260711_1935.woa
